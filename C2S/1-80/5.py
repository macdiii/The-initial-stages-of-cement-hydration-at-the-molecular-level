...
for p in range(41,n_file+1):
    ...
    with open("/public3/home/scg5448/pythonc2s/dump/{}/dump2.trj".format(p),"r") as f1:             
    ...
    for i in range(0,len(dumplines),natoms+9) :
        ...
        big_atom,a1,a2,a3,a4,a5,a6,a7,a8,a9=huge_atoms(atom,xlo,xhi_boundary,ylo,yhi,xhi)
    ...
    df.to_csv("/public3/home/scg5448/part1/c2s/save/O_Ca_H_{}.csv".format(p))
