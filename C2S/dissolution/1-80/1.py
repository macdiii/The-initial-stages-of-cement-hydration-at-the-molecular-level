...
for p in range(157,n_file+1):
    print("dos:",p)
    Ca_solubility=np.zeros((10000,20))
    with open("/scratch/pawsey0795/danial_armaghani/charles/xu/md/h2o-c2s-c3s/c2s/{}/dump2.trj".format(p),"r") as f1:      
    ...
    df.to_csv("/scratch/pawsey0795/danial_armaghani/charles/xu/md/h2o-c2s-c3s/c2s/Ca{}.csv".format(p))
